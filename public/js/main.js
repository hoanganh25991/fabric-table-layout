...
},{"vue":4}],6:[function(require,module,exports){
"use strict";
	...
	methods: {
		...
		handleLayoutExportSuccess: function handleLayoutExportSuccess() {
			...
			if (this.exportLayoutsCount == this.layouts.length) {
				...
				this.$http.post(this.url, this.layouts).then(function (response) {
...
},{"./components/LayoutInfo":5,"./components/LayoutTable":6,"./components/TableInfo":7,"jquery":1,"vue":4,"vue-resource":3}]},{},[8]);
